        ...
        <div className="flex flex-col md:flex-row-reverse items-center">
          ...
          animationDelay: '0.1s'
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-carmen-navy mb-6 leading-tight text-balance max-w-md lg:max-w-xl">
              <span className="bg-carmen-gradient bg-clip-text text-transparent">Flexible software</span> that adapts to your business needs
            </h1>
            <p className="text-lg text-gray-600 mb-8 max-w-lg text-balance">Carmen grows with your business. Start with the essentials and add modules as you need them. No more paying for features you don't use.</p>
              ...
              <div className="relative bg-white p-2 rounded-3xl shadow-soft overflow-hidden border border-white">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white/90 to-white/0 p-4">
                  <div className="bg-white/90 backdrop-blur-sm p-4 rounded-2xl shadow-sm border border-white">
                    <h3 className="text-carmen-navy font-semibold mb-1">Modular BPM Solutions</h3>
                    <p className="text-sm text-gray-600">Add only the features your business needs</p>
                  </div>
                </div>
              </div>
            </div>
