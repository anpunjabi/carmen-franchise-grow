...
const Hero = () => {
  return (
    <section className="relative pt-20 md:pt-32 pb-16 md:pb-24 overflow-hidden bg-carmen-cream" id="hero">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0 fade-in-up" style={{animationDelay: '0.1s'}}>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                variant="outline" 
                className="border-carmen-teal text-carmen-teal hover:bg-carmen-teal/10 rounded-xl"
