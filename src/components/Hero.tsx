  ...
  return (
    <section className="relative pt-20 md:pt-32 pb-16 md:pb-24 overflow-hidden" id="hero">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-40 -right-40 w-96 h-96 rounded-full bg-carmen-light-purple/30 blur-3xl"></div>
        <div className="absolute top-1/2 -left-40 w-96 h-96 rounded-full bg-carmen-purple/20 blur-3xl"></div>
      </div>
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0 fade-in-up" style={{animationDelay: '0.1s'}}>
            <div className="inline-block px-4 py-1 mb-6 rounded-full bg-carmen-gradient-light bg-opacity-10 border border-carmen-light-purple/30">
              <p className="text-carmen-dark-purple text-sm font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                variant="outline" 
                className="border-carmen-purple text-carmen-purple hover:bg-carmen-light-purple/30"
          ...
          <div className="md:w-1/2 md:pl-12 fade-in-up" style={{animationDelay: '0.3s'}}>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-carmen-dark-purple/20 to-carmen-purple/20 rounded-xl blur-xl animate-floating"></div>
