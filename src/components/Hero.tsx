      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          animationDelay: '0.1s'
            ...
            <EditableText id={getContentId("hero-paragraph")} as="p" className="text-lg text-gray-600 mb-8 max-w-lg text-balance" data-editable-id="hero-description">
            ...
            <div className="flex flex-col sm:flex-row gap-4" data-editable-id="hero-buttons">
          ...
          animationDelay: '0.3s'
        }} data-editable-id="hero-image-section">
