      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-12 md:mb-0 fade-in-up" style={{animationDelay: '0.1s'}}>
            <div className="inline-block px-4 py-1 mb-6 rounded-full bg-carmen-gradient-light bg-opacity-10 border border-carmen-light-blue/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="carmen-btn" onClick={() => window.location.href = '#contact'}>
                Build with Us
                <ArrowRight size={16} className="ml-2" />
              </Button>
              <Button 
                variant="outline" 
                className="border-carmen-teal text-carmen-teal hover:bg-carmen-teal/5"
          ...
          <div className="md:w-1/2 md:pl-12 fade-in-up" style={{animationDelay: '0.3s'}}>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-carmen-teal/20 to-carmen-blue/20 rounded-xl blur-xl animate-floating"></div>
              <div className="relative bg-white p-1 rounded-xl shadow-glass-lg overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-white/90 to-white/0 p-4">
                  <div className="bg-white/80 backdrop-blur-sm p-4 rounded-lg shadow-sm border border-white/50">
                    <h3 className="text-carmen-dark-blue font-semibold mb-1">Custom BPM Dashboard</h3>
