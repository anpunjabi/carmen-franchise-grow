...
const HeroTertiary = () => {
  return (
    <section className="relative pt-20 md:pt-32 pb-16 md:pb-24 overflow-hidden bg-carmen-cream" id="hero-tertiary">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          animationDelay: '0.1s'
            ...
            <EditableText id="hero-tertiary-paragraph" as="p" className="text-lg text-gray-600 mb-8 max-w-lg text-balance">
