      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          ...
          animationDelay: '0.1s'
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-lg text-balance">Now, it isn't. Carmen is a flexible, modular BPM builder that adapts to your business needs, not the other way around. Create a custom solution with only the features you need.</p>
